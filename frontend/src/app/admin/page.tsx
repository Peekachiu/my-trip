        ...
        <div className="p-4 min-h-screen">
            <section className="mb-8 mt-6">
                <div className="flex justify-between items-center mb-2">
                    <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100">{t('dashboard.users')}</h2>
                        ...
                        <div key={u.id} onClick={() => handleUserClick(u)} className="glass-card p-4 flex items-center gap-4 hover:shadow-md transition-shadow cursor-pointer group">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="flex items-center gap-2">
                                    <span className="text-xs text-brand-magenta font-bold uppercase tracking-wider bg-brand-light-magenta/20 px-2 py-0.5 rounded-full">{t(`roles.${u.role}` as any)}</span>
                                </div>
                            </div>
            ...
            <section className="pb-20">
                <div className="flex justify-between items-center mb-2">
                    <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100">{t('dashboard.allTrips')}</h2>
                    ...
                    <div className="glass-card bg-white/90 dark:bg-gray-900/95 p-6 w-full max-w-md m-4 relative shadow-2xl dark:border-gray-700" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="space-y-2 max-h-60 overflow-y-auto mb-6">
                            {userTrips.length === 0 ? (
                                ...
                                userTrips.map(t => (
                                    <div key={t.id} className="border border-gray-100 dark:border-gray-700 rounded-lg p-3 bg-white/50 dark:bg-gray-800/50 hover:bg-white dark:hover:bg-gray-800 transition-colors">
